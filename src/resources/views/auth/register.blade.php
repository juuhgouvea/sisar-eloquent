...
@section('pagina-ativa')
    <a href="{{ route('register') }}" class="d-flex align-items-center justify-content-center text-white">
        <img class="w-25" src="{{ url('images/registro_ico.png') }}" alt="Registro">
        <h4 class="m-0 ml-2">Registro</h4>
    </a>
@endsection
...
@section('conteudo')
    <main id="pagina-registro" class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-dark text-white font-weight-bold">{{ __('Registro - Aluno') }}</div>
